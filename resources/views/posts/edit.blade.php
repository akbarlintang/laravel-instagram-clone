        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    ...
                    <input id="caption" type="text" name="caption" class="form-control @error('caption') is-invalid @enderror" value="{{ old('caption') ?? $post->caption }}" autocomplete="caption" autofocus>
